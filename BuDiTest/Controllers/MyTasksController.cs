...
namespace BuDiTest.Controllers
{
    public class MyTasksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TaskID,TaskName,Description,DueDate,RaisedByEmployeeId,AssignedToEmployeeId,AttchmentName,Status,Priority")] MyTask myTask)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TaskID,TaskName,Description,DueDate,RaisedByEmployeeId,AssignedToEmployeeId,AttchmentName,Status,Priority")] MyTask myTask)
        {
            if (id != myTask.TaskID)
            {
                return NotFound();
