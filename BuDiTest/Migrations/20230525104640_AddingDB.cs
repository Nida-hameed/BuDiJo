    ...
    public partial class AddingDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ClockEventID = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClockEvents", x => x.ClockEventID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RaisedByEmployeeId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AssignedToEmployeeId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AttchmentName = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeTasks_Task_TaskID",
                        column: x => x.TaskID,
                        principalTable: "Task",
